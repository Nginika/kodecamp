...
def prompt_chain(user_complaint):
    ...
    step2Response = run_prompt("prompts/2_possible_categories.txt",
    ...
    step3Response = run_prompt("prompts/3_best_category.txt",
    ...
    step4Response = run_prompt("prompts/4_extra_info.txt",
        step1Response=step1Response,
    ...
    step5Response = run_prompt("prompts/5_produce_reply.txt",
